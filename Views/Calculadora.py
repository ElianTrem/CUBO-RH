...
class Calcu(QWidget):
    ...
    def Calcular_Tiempo(self):
        ...
        try:
            # Convertir la cadena de texto a un objeto datetime usando el formato correcto
            fecha1 = datetime.strptime(fecha_str, '%d/%m/%Y')

            # Obtener la fecha actual
            fecha2 = QDate.currentDate()
            fecha2_str = fecha2.toString('dd/MM/yyyy')

            # Convertir la fecha actual formateada de nuevo a un objeto datetime
            fecha2_formateada = datetime.strptime(fecha2_str, '%d/%m/%Y')

            # Calcular la diferencia de días
            diferencia = fecha2_formateada - fecha1
            ...
            error_dialog = QuickAlert('error', 'Error', 'Formato de fecha inválido. Por favor, use el formato DD/MM/YYYY.')
            error_dialog.exec_()
...
class DropDown(QPushButton):
    ...
    def on_triggered(self, text):
        ...
        if text == "Menos de un año":  # "Menos de un año" seleccionado
